...
class AboutDialog(QDialog):
    ...
    def __init__(self):
        ...
        description = QLabel(
            ...
            "vessel plotting, track history, optional course/speed prediction lines and\n"
            "a configurable range limit, receiver message statistics, per-vessel RSSI\n"
            "and uptime tracking, and offline file analysis with an estimated\n"
